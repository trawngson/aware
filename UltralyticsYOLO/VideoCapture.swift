...
public class VideoCapture: NSObject, @unchecked Sendable {
  ...
  /// The most recent captured frame as UIImage (for frame capture feature)
  public var lastCapturedFrame: UIImage?
  ...
  private func predictOnFrame(sampleBuffer: CMSampleBuffer) {
    ...
    if currentBuffer == nil, let pixelBuffer = CMSampleBufferGetImageBuffer(sampleBuffer) {
      ...
      // Store the current frame as UIImage for capture feature
      lastCapturedFrame = imageFromPixelBuffer(pixelBuffer)
  ...
  /// Captures the current frame as UIImage
